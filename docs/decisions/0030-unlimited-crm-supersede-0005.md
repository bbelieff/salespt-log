# ADR-0030 — 무제한 CRM: 8주=코스 기간 재정의 + 편집가드/주차 재정의 (0005 supersede)
...
> 결정 내용은 **불변** — 후발 문서인 이 ADR만 **0030**으로 재발행한다. 코드·문서 내 "ADR-0029"가
> 이 결정(무제한 CRM·편집가드·archived)을 가리키던 곳은 전부 "ADR-0030"으로 갱신했다.
