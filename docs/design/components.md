...
**용도**: 생산성 지표 4개 — `DB 퀄리티 / 컨택성공률 / 미팅숙련도 / 영업생산성` (사용자 결정 2026-05-08 통일안).

**4지표 정의** ([data-model.md §생산성 지표](../domains/data-model.md#생산성-지표-4개) SSOT):

| 지표 | 공식 | 의미 |
|---|---|---|
| DB 퀄리티 | `컨택진행 ÷ 유입` | 들어온 DB가 부재/거절 없이 컨택된 비율 |
| 컨택성공률 | `미팅예약 ÷ 컨택진행` | 컨택 → 미팅예약 전환 (구 "컨택숙련도") |
| 미팅숙련도 | `계약 ÷ 미팅완료` | 미팅완료(계약+완료+취소) 중 계약 비율 |
| 영업생산성 | `계약 ÷ 컨택진행` | **종합** — 통화부터 계약까지 |

> ⚠ **미팅완료 정의 변경**: "완료+계약" → **"계약+완료+취소"** (변경만 제외). 사용자 결정 2026-05-08.
