...
> - **관련 문서**: db-first-unlimited-roadmap.md(R0~R6 원 로드맵), db-write-flip.md(R3 상세), db-migration-pilot.md(스키마)
...
| `writeProductionCountCell`(03 M 생산개수) | 🟡 R2 async 미러만 | S — 컨택경로 non-throw 분리 |
...
| 3 | ADR 0029 번호 충돌 정정 + CLAUDE.md §2.5 stale 수정 | — | S |
