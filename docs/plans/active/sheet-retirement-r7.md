...
| 20 | 시트 미러·수식 설치 인프라 폐기(제목 정정: `sheets_v4` 런타임 제거, `googleapis` 자체는 GCal·Drive 가 계속 씀) — **계획 완료(2026-08-10, BBE-69)**: 착수 조건(S0) 실측 결과 미충족(BBE-68 아직 Backlog·Export 개인전용) 확인, 코드 변경 0. 전수 목록·제거순서(S1~S5)·롤백법 = `docs/plans/active/sheet-retirement-bbe69.md` | 19 | L |
