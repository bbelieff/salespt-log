...
- 그룹 대표 = **body_md(전/후)가 적힌 행 중 최신**(없으면 최신 pr) — 후속 픽스 PR 이
  그룹에 합류해도 큐레이션 문구가 밀려나지 않는다(group-render 정정 2026-06-11).
  title_user(고객용 한 문장)·body_md(전/후)는 대표 행에 적는다(팝업관리에서 보정).
