...
- 검증: 신규 `tests/repo/company-archive-flip.test.ts`(14건 — DB실패시 즉시throw·시트미개입,
  ...
  check.sh 초록. PR **#786** 오픈, 머지→배포 관찰까지 계속 진행.
- SoR: `docs/plans/active/db-write-flip.md` Log(2026-08-10) · Linear BBE-60 코멘트(접수·설계).
