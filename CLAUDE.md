...
### MVP 스코프 (절대 원칙)
- **기간 한정**: 
  - 수강 기간 = 수강시작일 + 55일 (8주). 시트 N1에서 동적 계산.
  - 편집 가능 기간 = 수강시작일 + 69일 (8주 + 2주 마감 유예).
...
- **시트 탭 구조 (ADR-0003)**: 
  - 웹이 직접 쓰는 탭: **업체관리**(미팅), **수납관리**, 영업관리 E~H/M
  - 시트 수식이 자동 집계: 영업관리 I~L/N~T, **대시보드**
  - 웹이 영업관리 I~L/N~T에 직접 쓰면 린터로 차단
- **업체관리 탭**: 1행 = 1미팅. 웹은 append/update 단위로만 조작.
