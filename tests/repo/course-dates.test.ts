...
import { isSafeToOverwrite, planCourseDateWrite, parseCourseDateCells } from "@/repo/course-dates";

const CELLS = { o1Cell: "O1", o2Cell: "O2", startISO: "2026-07-10", gradISO: "2026-08-29" };

/**
 * BBE-69(S1) 로 `lib/repo/setup-formulas.ts` 폐기하며 `tests/repo/setup-formulas-guard.test.ts`
 * 에서 이전(유일한 외부 소비자 = 이 파일의 대상 모듈). 2026-05-14 사고 후속 —
 * installFormulas 가 무조건 수식으로 덮어써 사용자 raw 값 손실. 재발 차단 위해
