      ...
      {seasons.map((s) => {
        ...
        return (
          <PersistentDetails
            ...
            defaultOpen
            className="group overflow-hidden rounded-2xl border-2 border-purple-200 bg-purple-50/40 open:bg-white"
          >
            <summary className="flex cursor-pointer flex-wrap items-baseline gap-x-2 gap-y-0.5 border-l-4 border-purple-500 bg-purple-50 px-4 py-3 group-open:bg-white hover:bg-purple-100">
              <svg
                className="h-3.5 w-3.5 shrink-0 text-purple-500 transition-transform group-open:rotate-90"
                fill="none"
                stroke="currentColor"
                strokeWidth={2.5}
                viewBox="0 0 24 24"
