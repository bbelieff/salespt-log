...
/* 폭은 호출부(페이지 셸)가 정한다 — .trainer-access 루트에 max-width/margin/padding 을 두지 않는다.
   대신 자식이 부모를 밀어내지 않도록 넘침 가드만 둔다. */
.trainer-access .permission-layout{min-width:0}.trainer-access .permission-layout>*{min-width:0}.trainer-access .permission-head{flex-wrap:wrap}.trainer-access .permission-head>*{min-width:0}
