...
export default function TopHeader({
  ...
  return (
    <>
      ...
      {popupOpen && (
        <>
          ...
          <div className="fixed left-3 top-14 z-[56] w-64 overflow-hidden rounded-xl border border-gray-100 bg-white shadow-xl">
            ...
            {/* sessionRole 별 진입점 — admin 은 /admin, trainer 는 /trainer */}
      ...
      {/* Admin/Trainer 상태바 제거 (refactor/admin-ui-dedupe 2026-05-11):
            TopHeader 가 이미 impersonation 대상 사용자 정보(기수·이름·D-day)를
            표시 → 같은 정보 중복. 관리자/트레이너 진입점은 로고 popup 메뉴의
            sessionRole 별 링크로 제공. */}
