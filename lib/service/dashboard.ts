...
const PROTOTYPE_DUMMY: DashboardView = {
  ...
  channelMatrix: [
    // 미팅완료 = 계약 + 완료(미계약) + 취소 (변경 제외) — 사용자 결정 2026-05-08
    // 미팅예약 - 미팅완료 = 변경 + 아직 미정 (예약 상태)
    { 채널: "매입DB", 생산: 162, 유입: 130, 컨택진행: 110, 미팅예약: 50, 미팅완료: 45, 계약: 8 },
    { 채널: "직접생산", 생산: 78, 유입: 78, 컨택진행: 65, 미팅예약: 32, 미팅완료: 30, 계약: 6 },
    { 채널: "현수막", 생산: 96, 유입: 50, 컨택진행: 45, 미팅예약: 14, 미팅완료: 13, 계약: 4 },
    { 채널: "콜·지·기·소", 생산: 24, 유입: 24, 컨택진행: 22, 미팅예약: 14, 미팅완료: 12, 계약: 5 },
  ],
  weeklyTrend: [
    { 주차: 1, 영업이익: -20, 활동량: 50 },
    { 주차: 2, 영업이익: -10, 활동량: 60 },
